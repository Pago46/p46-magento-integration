...
namespace Pago46\Cashin\Block\Adminhtml\System\Config\Fieldset;
...
class Payment extends \Magento\Config\Block\System\Config\Form\Fieldset
{
    ...
    protected function _getHeaderTitleHtml($element)
    {
        ...
        $html .= '<div class="button-container"><button type="button"' .
            ...
            (empty($groupConfig['pago46_ec_separate']) ? '' : ' pago46-ec-separate') .
            $disabledClassString .
            '" id="' .
            $htmlId .
            '-head" onclick="configurePago46.call(this, \'' .
            $htmlId .
            "', '" .
            $this->getUrl(
                'adminhtml/*/state'
    ...
    protected function _getExtraJs($element)
    {
        $script = "require(['jquery', 'prototype'], function(jQuery){
            window.configurePago46 = function (id, url) {
                var doScroll = false;
